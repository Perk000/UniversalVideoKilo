...
namespace SilverTau.NSR
{
    ...
    [AddComponentMenu("Silver Tau/NSR/Screen Recorder (iOS Native)")]
    public class ScreenRecorder : MonoBehaviour
    {
        ...
        private static extern void nsr_native_initialize();
        
        [DllImport("__Internal")]
        private static extern void nsr_native_dispose();
        ...
        [DllImport("__Internal")]
        private static extern void share(String text);
        ...
        [DllImport("__Internal")]
        private static extern void saveVideoToPhotosAlbum(String text);
