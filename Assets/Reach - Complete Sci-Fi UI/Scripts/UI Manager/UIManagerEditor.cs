    ...
    public class UIManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showAch)
            {
                ...
                ReachUIEditorHandler.DrawProperty(commonColor, customSkin, "Common Color");
                ReachUIEditorHandler.DrawProperty(rareColor, customSkin, "Rare Color");
                ReachUIEditorHandler.DrawProperty(legendaryColor, customSkin, "Legendary Color");
            }
            ...
            if (showColors)
            {
                ...
                ReachUIEditorHandler.DrawProperty(accentColor, customSkin, "Accent Color");
                ReachUIEditorHandler.DrawProperty(accentColorInvert, customSkin, "Accent Match");
                ReachUIEditorHandler.DrawProperty(primaryColor, customSkin, "Primary Color");
                ReachUIEditorHandler.DrawProperty(secondaryColor, customSkin, "Secondary Color");
                ReachUIEditorHandler.DrawProperty(negativeColor, customSkin, "Negative Color");
                ReachUIEditorHandler.DrawProperty(backgroundColor, customSkin, "Background Color");
            }
